...
export const SHIPS = {
  raven: {
    ...
    description: 'A versatile vanguard fighter built for rapid atmospheric exit and high-G combat maneuvers near gravity hazards.',
    stats: { speed: 8, firepower: 7, durability: 7, shields: 8, agility: 9 },
    specs: [
  ...
  phantom: {
    ...
    description: 'Equipped with radar-dampening carbon weave and supercharged plasma burners for extreme escape velocity.',
    stats: { speed: 10, firepower: 6, durability: 5, shields: 6, agility: 10 },
    specs: [
  ...
  interceptor: {
    ...
    description: 'Reinforced heavy combat frame harnessing dark energy singularity siphons and obsidian reactive plating.',
    stats: { speed: 6, firepower: 10, durability: 9, shields: 9, agility: 6 },
    specs: [
