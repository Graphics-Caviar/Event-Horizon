...
export class LandingUI {
  constructor({
    ...
    this.debriefPanel = document.getElementById('landing-debrief-panel');
    this.skipBtn = document.getElementById('btn-landing-skip');
    this.continueBtn = document.getElementById('btn-landing-continue');
    this.replayBtn = document.getElementById('btn-landing-replay');
    this.menuBtn = document.getElementById('btn-landing-menu');

    this.vesselNameEl = document.getElementById('landing-vessel-name');
  ...
  _populateData() {
    ...
    if (this.callsignEl) {
      this.callsignEl.textContent = this.playerName || 'Explorer';
    }
  }
