...
export class AudioManager {
  ...
  setThrusterLevel(level01) {
    ...
    this._thrustGain.gain.setTargetAtTime(level01 * 0.05, this.ctx.currentTime, 0.08);
  }
  ...
  playCollect() { this._blip(500, 1100, 0.18, 'triangle', 0.18); }
  playImpact() { this._blip(180, 40, 0.3, 'square', 0.25); }
  playWarning() { this._blip(220, 220, 0.15, 'square', 0.12); }
  playEscape() { this._blip(300, 900, 1.1, 'sine', 0.2); }
  playCrash() { this._blip(150, 20, 1.4, 'sawtooth', 0.3); }
}
