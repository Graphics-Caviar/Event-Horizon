...
export default class PilotInfoPanel {
  ...
  setCharacter(character) {
    ...
    const statsRows = STAT_KEYS.map((key) => `
    ...
    this._el.querySelector('.pilot-info-panel__abilities-mount').appendChild(abilityList.element);

    this._el.querySelector('.pilot-info-panel__select-btn').addEventListener('click', () => {
