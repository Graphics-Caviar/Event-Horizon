    ...
    abilities: [
      {
        id: 'salvage-expert',
        name: 'SALVAGE EXPERT',
        description: 'Find more resources and ammunition.',
        icon: 'salvage-expert',
      },
      {
        id: 'repair-drone',
        name: 'REPAIR DRONE',
        description: 'Deploy a drone that repairs your vehicle.',
        icon: 'repair-drone',
      },
      {
        id: 'hacker',
        name: 'HACKER',
        description: 'Bypass systems and unlock restricted areas.',
        icon: 'hacker',
      },
    ],
...

  {
    ...
    abilities: [
      ...
      },
      {
        id: 'phase-step',
        name: 'PHASE STEP',
        description: 'Short teleport through obstacles.',
        icon: 'phase-step',
      },
      {
        id: 'void-shield',
        name: 'VOID SHIELD',
        description: 'Become intangible for a short time.',
        icon: 'void-shield',
      },
    ],
